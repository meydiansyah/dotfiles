  ...
  "node_modules/vscode-languageserver-types/lib/umd/main.js"(exports, module2) {
    (function(factory) {
      ...
      (function(Position6) {
        ...
        Position6.is = is;
      })(Position5 || (exports2.Position = Position5 = {}));
      var Range3;
      (function(Range4) {
...
// node_modules/@vue/language-server/out/protocol.js
var require_protocol2 = __commonJS({
  "node_modules/@vue/language-server/out/protocol.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var vscode = __importStar(require_main3());
    var GetComponentMeta2;
    (function(GetComponentMeta3) {
      GetComponentMeta3.type = new vscode.RequestType("vue/componentMeta");
    })(GetComponentMeta2 || (exports.GetComponentMeta = GetComponentMeta2 = {}));
...
// node_modules/@vue/language-server/out/types.js
var require_types = __commonJS({
  "node_modules/@vue/language-server/out/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/@volar/language-server/out/protocol.js
var require_protocol3 = __commonJS({
  "node_modules/@volar/language-server/out/protocol.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var FindFileReferenceRequest2;
    (function(FindFileReferenceRequest3) {
      FindFileReferenceRequest3.type = new vscode.RequestType("volar/client/findFileReference");
    })(FindFileReferenceRequest2 || (exports.FindFileReferenceRequest = FindFileReferenceRequest2 = {}));
    ...
    var ReloadProjectNotification2;
    (function(ReloadProjectNotification3) {
      ReloadProjectNotification3.type = new vscode.NotificationType("volar/client/reloadProject");
    })(ReloadProjectNotification2 || (exports.ReloadProjectNotification = ReloadProjectNotification2 = {}));
    ...
    (function(GetVirtualFileRequest3) {
      GetVirtualFileRequest3.type = new vscode.RequestType("volar/client/virtualFile");
    })(GetVirtualFileRequest2 || (exports.GetVirtualFileRequest = GetVirtualFileRequest2 = {}));
  }
});

// node_modules/@volar/language-server/out/types.js
var require_types2 = __commonJS({
  "node_modules/@volar/language-server/out/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DiagnosticModel = exports.ServerMode = void 0;
    var ServerMode2;
    (function(ServerMode3) {
      ServerMode3[ServerMode3["Semantic"] = 0] = "Semantic";
      ServerMode3[ServerMode3["PartialSemantic"] = 1] = "PartialSemantic";
      ServerMode3[ServerMode3["Syntactic"] = 2] = "Syntactic";
    })(ServerMode2 || (exports.ServerMode = ServerMode2 = {}));
    var DiagnosticModel2;
    (function(DiagnosticModel3) {
      DiagnosticModel3[DiagnosticModel3["None"] = 0] = "None";
      DiagnosticModel3[DiagnosticModel3["Push"] = 1] = "Push";
      DiagnosticModel3[DiagnosticModel3["Pull"] = 2] = "Pull";
    })(DiagnosticModel2 || (exports.DiagnosticModel = DiagnosticModel2 = {}));
  }
});

// node_modules/@volar/language-service/out/types.js
var require_types3 = __commonJS({
  "node_modules/@volar/language-service/out/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_types4 = __commonJS({
  "node_modules/@vue/language-core/out/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/@vue/language-service/out/types.js
var require_types5 = __commonJS({
  "node_modules/@vue/language-service/out/types.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
// node_modules/@vue/language-server/out/index.js
var require_out = __commonJS({
  "node_modules/@vue/language-server/out/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
var import_language_server2 = __toESM(require_out());
...
// src/client/commands/initializeTakeOverMode.ts
var import_coc2 = require("coc.nvim");
async function register2(context) {
  context.subscriptions.push(import_coc2.commands.registerCommand("volar.initializeTakeOverMode", initializeTakeOverModeCommand()));
}
function initializeTakeOverModeCommand() {
  return async () => {
    const enableTakeOverMode = await import_coc2.window.showPrompt("Enable Take Over Mode?");
    const config2 = import_coc2.workspace.getConfiguration("volar");
    const tsserverConfig = import_coc2.workspace.getConfiguration("tsserver");
    if (enableTakeOverMode) {
      config2.update("takeOverMode.enabled", true);
      tsserverConfig.update("enable", false);
    } else {
      config2.update("takeOverMode.enabled", false);
...
async function register3(context) {
  if (import_coc3.workspace.getConfiguration("volar").get("scaffoldSnippets.enable")) {
    context.subscriptions.push(
      import_coc3.languages.registerCompletionItemProvider(
        "volar",
        "volar",
        ["vue"],
...
var scaffoldSnippetsCompletionProvider = class {
  ...
  async resolveCompletionItem(item) {
    if (item.kind === import_coc3.CompletionItemKind.Snippet) {
...
// src/client/statusBar.ts
var import_coc4 = require("coc.nvim");
async function register4(context, languageClient) {
  await languageClient.onReady();
  const statusBar = import_coc4.window.createStatusBarItem(99);
  updateStatusBar();
  import_coc4.events.on(
    "BufEnter",
    async () => {
      updateStatusBar();
    },
  ...
  async function updateStatusBar() {
    const { document } = await import_coc4.workspace.getCurrentState();
    if (import_coc4.workspace.getConfiguration("volar").get("takeOverMode.enabled") && ["vue", "javascript", "typescript", "javascriptreact", "typescriptreact"].includes(document.languageId)) {
      statusBar.text = "Volar (TakeOverMode)";
      statusBar.show();
    } else if (import_coc4.workspace.getConfiguration("volar").get("takeOverMode.enabled") && import_coc4.workspace.getConfiguration("volar").get("vitePressSupport.enable") && ["markdown"].includes(document.languageId)) {
      statusBar.text = "Volar (TakeOverMode)";
      statusBar.show();
    } else if (import_coc4.workspace.getConfiguration("volar").get("takeOverMode.enabled") && import_coc4.workspace.getConfiguration("volar").get("petiteVueSupport.enable") && ["html"].includes(document.languageId)) {
      statusBar.text = "Volar (TakeOverMode)";
      statusBar.show();
    } else if (import_coc4.workspace.getConfiguration("volar").get("vitePressSupport.enable") && ["markdown"].includes(document.languageId)) {
      statusBar.text = "Volar";
      statusBar.show();
    } else if (import_coc4.workspace.getConfiguration("volar").get("petiteVueSupport.enable") && ["html"].includes(document.languageId)) {
      statusBar.text = "Volar";
      statusBar.show();
...
// src/requestTypes.ts
var import_language_server = __toESM(require_out());
var coc = __toESM(require("coc.nvim"));
var FindFileReferenceRequestType = new coc.RequestType(import_language_server.FindFileReferenceRequest.type.method);
var AutoInsertRequestType = new coc.RequestType(import_language_server.AutoInsertRequest.type.method);
var ReloadProjectNotificationType = new coc.NotificationType(import_language_server.ReloadProjectNotification.type.method);
var GetVirtualFileRequestType = new coc.RequestType(import_language_server.GetVirtualFileRequest.type.method);
var GetComponentMetaType = new coc.RequestType(import_language_server.GetComponentMeta.type.method);

// src/features/autoInsertion.ts
async function register5(context, htmlClient, tsClient) {
  ...
  let isEnabled = false;
  let bufnr;
  import_coc5.workspace.document.then((doc) => {
    bufnr = doc.bufnr;
    updateEnabledState(doc.bufnr);
  });
  import_coc5.events.on(
    "BufEnter",
    async (bn) => {
      bufnr = bn;
      if (timeout)
      ...
      if (!doc) {
        doc = await import_coc5.workspace.document;
      }
  ...
  function updateEnabledState(bufnr2) {
    isEnabled = false;
    const document = import_coc5.workspace.getDocument(bufnr2);
  ...
  import_coc5.workspace.onDidChangeTextDocument(
    (event) => {
  ...
  async function onDidChangeTextDocument(document, changes) {
    ...
    if (!import_coc5.Range.is(lastChange["range"]) || !lastChange.text) {
      return;
    }
    const lastCharacter = lastChange.text[lastChange.text.length - 1];
    if (lastCharacter === "/")
      return;
    if (!import_coc5.workspace.getConfiguration("volar").get("autoClosingTags")) {
      if (lastCharacter === ">")
        return;
    }
    if (!import_coc5.workspace.getConfiguration("volar").get("autoCreateQuotes")) {
      if (lastCharacter === "=")
        return;
    }
    ...
    doAutoInsert(document, lastChange, async (document2, position, lastChange2) => {
      ...
      const result = await htmlClient.sendRequest(AutoInsertRequestType.method, params) ?? await tsClient.sendRequest(AutoInsertRequestType.method, params);
  ...
  function doAutoInsert(document, lastChange, provider) {
    ...
    timeout = setTimeout(() => {
      const position = import_coc5.Position.create(rangeStart.line, rangeStart.character + lastChange.text.length);
        ...
        if (text && isEnabled) {
          ...
          if (document.uri === activeDocument.uri && activeDocument.version === version) {
            if (typeof text === "string") {
              if (lastChange.text === ">") {
                import_coc5.snippetManager.insertSnippet(text, true, import_coc5.Range.create(position, position));
              } else if (lastChange.text === "=") {
                import_coc5.snippetManager.insertSnippet(text, true, import_coc5.Range.create(position, position));
              } else {
                if (import_coc5.workspace.getConfiguration("vue").get("autoInsert.dotValue")) {
                  import_coc5.snippetManager.insertSnippet(text, true, import_coc5.Range.create(position, position));
                }
              }
            } else {
              import_coc5.snippetManager.insertSnippet(new import_coc5.SnippetString(text.newText), true, text.range);
            }
          }
        }
      });
...
// src/features/componentMeta.ts
var import_coc6 = require("coc.nvim");
var import_path3 = __toESM(require("path"));
async function register6(context, client) {
  await client.onReady();
  context.subscriptions.push(
    import_coc6.commands.registerCommand("volar.action.showComponentMeta", async () => {
      const { document } = await import_coc6.workspace.getCurrentState();
      const meta = await client.sendRequest(GetComponentMetaType, {
        uri: document.uri
      });
      const bufferName = import_path3.default.basename(document.uri) + ".meta.json";
      await import_coc6.workspace.nvim.command(`belowright vnew ${bufferName} | setlocal buftype=nofile bufhidden=hide noswapfile filetype=json`).then(async () => {
        const buf = await import_coc6.workspace.nvim.buffer;
        buf.setLines(JSON.stringify(meta, void 0, "	").split("\n"), { start: 0, end: -1 });
      });
    })
  );
}

// src/features/fileReferences.ts
var import_coc7 = require("coc.nvim");
async function register7(cmd, client) {
  import_coc7.commands.registerCommand(cmd, async (uri) => {
    await import_coc7.window.withProgress(
      {
      ...
      async (_progress, token) => {
        if (!uri) {
          ...
          uri = import_coc7.Uri.parse(document.uri);
        }
        ...
        await import_coc7.commands.executeCommand(
          "editor.action.showReferences",
          uri,
          import_coc7.Position.create(0, 0),
          response.map(
            (ref) => import_coc7.Location.create(
              ref.uri,
              import_coc7.Range.create(
                import_coc7.Position.create(ref.range.start.line, ref.range.end.line),
                import_coc7.Position.create(ref.range.end.line, ref.range.end.character)
              )
            )
          )
        );
...
// src/features/reloadProject.ts
var import_coc8 = require("coc.nvim");
async function register8(cmd, context, client) {
  context.subscriptions.push(
    import_coc8.commands.registerCommand(cmd, async () => {
...
function getCurrentTsPaths(context) {
  ...
  const builtinTsPaths = {
    tsdk: import_path4.default.join(context.extensionPath, "node_modules", "typescript", "lib")
  };
...
function getWorkspaceTsPaths(useDefault = false) {
  ...
  if (tsdk) {
    const tsPath = getWorkspaceTypescriptPath(
      tsdk,
      import_coc9.workspace.workspaceFolders.map((folder) => import_coc9.Uri.parse(folder.uri).fsPath)
    );
    if (tsPath) {
      return {
        tsdk: tsPath
...
function getWorkspaceTypescriptPath(tsdk, workspaceFolderFsPaths) {
  if (import_path4.default.isAbsolute(tsdk)) {
    ...
    for (const folder of workspaceFolderFsPaths) {
      const tsPath = findTypescriptModulePathInLib(import_path4.default.join(folder, tsdk));
      if (tsPath) {
        return tsPath;
      }
    }
...
function getConfigUseWorkspaceTsdk() {
  return import_coc9.workspace.getConfiguration("volar").get("useWorkspaceTsdk", false);
}
function getConfigCocTsserverTsdk() {
  return import_coc9.workspace.getConfiguration("tsserver").get("tsdk");
}

// src/config.ts
var import_coc10 = require("coc.nvim");
var _config = () => import_coc10.workspace.getConfiguration("vue");
var config = {
...
function getConfigVolarEnable() {
  return import_coc10.workspace.getConfiguration("volar").get("enable", true);
}
function getConfigDisableProgressNotifications() {
  return import_coc10.workspace.getConfiguration("volar").get("disableProgressNotifications", false);
}
function getConfigMiddlewareProvideCompletionItemEnable() {
  return import_coc10.workspace.getConfiguration("volar").get("middleware.provideCompletionItem.enable", true);
}
function getDisabledFeatures() {
  const disabledFeatures = [];
  if (import_coc10.workspace.getConfiguration("volar").get("disableDiagnostics")) {
    disabledFeatures.push("diagnostics");
  }
  if (import_coc10.workspace.getConfiguration("volar").get("disableFormatting")) {
...
async function activate(context, createLc) {
  ...
  if (!activated) {
    ...
    if (!activated && currentLangId === "markdown" && config.server.vitePress.supportMdFile || !activated && currentLangId === "html" && config.server.petiteVue.supportHtmlFile) {
      doActivate(context, createLc);
      activated = true;
    }
    const takeOverMode = takeOverModeEnabled();
    if (!activated && takeOverMode && ["javascript", "typescript", "javascriptreact", "typescriptreact"].includes(currentLangId)) {
      doActivate(context, createLc);
      activated = true;
    }
  }
  import_coc11.workspace.onDidOpenTextDocument(
    async () => {
      if (activated)
        return;
      const { document } = await import_coc11.workspace.getCurrentState();
...
async function doActivate(context, createLc) {
  ...
  const semanticOutputChannel = import_coc11.window.createOutputChannel("Vue Semantic Server");
  const syntacticOutputChannel = import_coc11.window.createOutputChannel("Vue Syntactic Server");
  [semanticClient, syntacticClient] = await Promise.all([
    createLc(
      "vue-semantic-server",
      "Vue Semantic Server",
      getDocumentSelector(context, import_language_server2.ServerMode.PartialSemantic),
      await getInitializationOptions(import_language_server2.ServerMode.PartialSemantic, context),
      6009,
    ...
    createLc(
      ...
      "Vue Syntactic Server",
      getDocumentSelector(context, import_language_server2.ServerMode.Syntactic),
      await getInitializationOptions(import_language_server2.ServerMode.Syntactic, context),
      6011,
  ...
  register8("volar.action.reloadProject", context, semanticClient);
  register(context);
  register3(context);
  if (semanticClient) {
    register4(context, semanticClient);
    register7("volar.vue.findAllFileReferences", semanticClient);
    if (import_coc11.workspace.getConfiguration("volar").get("autoCreateQuotes") || import_coc11.workspace.getConfiguration("volar").get("autoClosingTags") || import_coc11.workspace.getConfiguration("vue").get("autoInsert.dotValue")) {
      register5(context, syntacticClient, semanticClient);
    }
    register6(context, semanticClient);
  }
  async function registerRestartRequest() {
    await Promise.all(clients.map((client) => client.onReady()));
    context.subscriptions.push(
      import_coc11.commands.registerCommand("volar.action.restartServer", async () => {
...
function deactivate() {
  return Promise.all([semanticClient == null ? void 0 : semanticClient.stop(), syntacticClient == null ? void 0 : syntacticClient.stop()]);
}
function takeOverModeEnabled() {
  return !!import_coc11.workspace.getConfiguration("volar").get("takeOverMode.enabled");
}
function getDocumentSelector(_context, serverMode) {
  const takeOverMode = takeOverModeEnabled();
  const selectors = [];
  ...
  if (takeOverMode) {
    ...
    if (serverMode === import_language_server2.ServerMode.Semantic || serverMode === import_language_server2.ServerMode.PartialSemantic) {
...
async function getInitializationOptions(serverMode, context, options = {}) {
  ...
  options.diagnosticModel = config.server.diagnosticModel === "pull" ? import_language_server2.DiagnosticModel.Pull : import_language_server2.DiagnosticModel.Push;
...
async function activate2(context) {
  ...
  return activate(context, (id, name, documentSelector, initOptions, port, outputChannel) => {
    class _LanguageClient extends import_coc12.LanguageClient {
      fillInitializeParams(params) {
        params.locale = import_coc12.workspace.getConfiguration("volar").get("tsLocale", "en");
      }
    }
    const vueServerPath = config.server.path ? import_coc12.workspace.expand(config.server.path) : null;
    if (vueServerPath != null && fs4.existsSync(vueServerPath)) {
      serverModule = vueServerPath;
    } else {
      serverModule = context.asAbsolutePath(
        path5.join("node_modules", "@vue", "language-server", "bin", "vue-language-server.js")
      );
    }
    const runOptions = {};
    ...
    const serverOptions = {
      run: {
        module: serverModule,
        transport: import_coc12.TransportKind.ipc,
        options: runOptions
      },
      debug: {
        module: serverModule,
    ...
    const clientOptions = {
      ...
      middleware: {
        provideCompletionItem: getConfigMiddlewareProvideCompletionItemEnable() ? id === "vue-semantic-server" ? handleProvideCompletionItem : void 0 : void 0
      },
      outputChannel
    };
    const client = new _LanguageClient(id, name, serverOptions, clientOptions);
    context.subscriptions.push(import_coc12.services.registLanguageClient(client));
    return client;
  });
}
